...
Revision ID: 6c1cb2397340
Revises: 
Create Date: 2023-02-23 06:08:45.963557
...
def upgrade():
    ...
    op.create_index(op.f('ix_user_calendar_google_id'), 'user_calendar', ['google_id'], unique=False)
