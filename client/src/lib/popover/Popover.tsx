...
class Popover extends React.Component<PopoverProps, PopoverState> {
  ...
  private getNudgedPopoverPosition({
    ...
    top =
      top! + height! > window.innerHeight - padding ? window.innerHeight - padding - height! : top
    left = left! < padding ? padding : left
    left =
      left! + width! > window.innerWidth - padding ? window.innerWidth - padding - width! : left
  ...
  private createContainer(): HTMLDivElement {
    ...
    if (containerStyle) {
      Object.keys(containerStyle).forEach(
        (key) => (container.style[key as any] = (containerStyle as CSSStyleDeclaration)[key as any])
      )
    }
    ...
    this.renderWithPosition(
      ...
      (violation, rect) => {
        ...
        if (violation && !disableReposition && !(typeof contentLocation === 'object')) {
          ...
          this.popoverDiv!.style.width = ''
          this.popoverDiv!.style.height = ''
