      ...
      <Layout>
        <section>
          <div className="container">
            <h1 className="title">Time Trends</h1>
            <p className="subtitle">Activities over time.</p>
            <div className="notification columns">{this.renderDropdown()}</div>
          </div>
          ...
          <div className="container">
            <div className="columns is-multiline">
              ...
              <div className="card column is-5">
                <div className="">{this.renderLineChart()}</div>
              </div>
            </div>
          </div>
        </section>
