...
export type ConferenceType = 'google' | 'zoom'
...
export default class ConferenceData {
  ...
  static newHangoutsMeet(): ConferenceData {
    return new ConferenceData(
      ...
      null,
      [],
      new CreateRequest('hangoutsMeet', 'pending'),
      'google'
    )
  }

  static newZoomMeet(): ConferenceData {
    return new ConferenceData(null, null, [], new CreateRequest('addOn', 'pending'), 'zoom')
  }
